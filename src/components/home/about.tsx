const About = () => {
  return (
    <div className="mx-auto w-5/6 pb-24">
      <p className="to-starlight-yellow-primary bg-gradient-to-r from-white to-[70%] bg-clip-text pb-2 text-center text-5xl font-bold text-transparent md:to-30% md:text-left">
        What is ACM
      </p>
      <p className="to-starlight-yellow-primary bg-gradient-to-r from-white to-[70%] bg-clip-text pb-6 text-center text-5xl font-bold text-transparent md:to-30% md:text-left">
        Starlight?
      </p>
